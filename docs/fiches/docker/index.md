**Objectif**: L'objectif de ce TP est de te permettre d'utiliser docker comme technologie de déploiement d'applications dans une architecture de microservice.
